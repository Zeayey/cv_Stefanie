    ...
    ======================================================-->
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
              ...
              <h1 class="mb-0" style="color:pink;">Stefanie
              </h1>
              <div class="subheading mb-5"> Currently study at Universitas Internasional Batam
                  <a href="#">Majoring at Information System </a>
              </div>
              <p class="mb-5" style="max-width: 500px;color:blue;" >Graduated from SMAK Yos Sudarso Batam , and have experience in Graphics designing and as a small bisnis owner.</p>
          ...
          <div class="row my-auto">
              ...
              <div class="resume-item col-md-6 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i> logo designer </h4>
                      <p>design an original creativity and design a logo needs a fresh idea , from the start we need to have our drawing style and skill  </p>
                  </div>
              ...
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i>  pro gaming</h4>
                      <p>started a small gaming community , and play in it as a team with team mate and started play professionaly. </p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">November 2018 - Desember 2020</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #28a745; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-camera mr-3 text-success"></i> sawry cake</h4>
                      <p>a small online cake store that i create for starting a small business and try to bake the perfect cake when the pandemic era </p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">July 2019 - December 2020</span>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-6 col-sm-12">
                <div class="card mx-0 p-4 mb-5" style="border-color: #2196f3; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class="resume-content mr-auto">
                      <h4 class="mb-3"><i class="fa fa-area-chart mr-3 text-primary"></i> online takeaway food</h4>
                      <p> cooking with passion seeing every person enjoying the food make me happy  </p>
                  </div>
                  <div class="resume-date text-md-right">
                      <span class="text-primary">September 2020 - June 2022</span>
                  </div>
                </div>  
              </div>
          </div>
    ...
    ======================================================-->       
      <section class=" d-flex flex-column" id="skills">
         <div class="p-lg-5 p-3 skill-cover">
          <h3 class="text-center text-white">Design Skills</h3>
              ...
              <div class="main-award" id="award-box">
                  <div class="award">
                      ...
                      <div class="award-content">
                          <span class="date">Apr 2019 - june 2019</span>
                          <h5 class="title"> 2nd place novelis as 2 months </h5>
                          <p class="description">
                        2 place from a golden cage novel with a fantasy genre for 2 month.
                          </p>
                      </div>
                  </div>
                  <div class="award">
                      ...
                      <div class="award-content">
                          ...
                          <h5 class="title">first place for school logo sticker competition. </h5>
                          <p class="description">
                              making a logo for sticker competition and win the first place.
                          </p>
                      </div>
                  </div>
              </div>
          ...
          <div class="row my-auto" id="contact"> 
            <div class="col-md-8">
              <div class="contact-cont">
                ...
                <p> I would be happy to answer your question and happy to be your business partner </p>
              </div>   
